...
const cadSimpleViewerExampleDist = path.resolve(rootDir, '../cad-simple-viewer-example/dist');
...
export async function copyDist() {
  ...
  await fs.copy(cadSimpleViewerExampleDist, cadSimpleViewer, { overwrite: true });
}
